...
const getDict = (params) => {
    ajaxOper.ajaxHttp({
        ...
        data: params.data,
        postType: "form",
        url: "/business/people/basic/findByTypeIds",
        successFunc: (data) => {
...
const getReg = (params) => {
    ajaxOper.ajaxHttp({
        type: 'get',
        url: "/business/building/basic/addivision/list",
        successFunc: (data) => {
            params.successFunc && params.successFunc(data);
        }
    })
...
const getDoorplate = (params) => {
    ajaxOper.ajaxHttp({
        type: 'get',
        url: "/business/building/basic/findRoomByCode",
        data: {
            gridCode: params.code
        },
        successFunc: (data) => {
            params.successFunc && params.successFunc(data);
        }
